// lib/defaultData.ts — Varsayılan içerik + font/renk/düzen seçenekleri

import type { CVData, FontOption, AccentOption, Settings, LineHeightOption, MarginOption } from "./types";
...
export const DEFAULT_DATA: CVData = {
  ...
  experience: [
    {
      _id: 1, role: "Senior Frontend Developer", company: "Trendyol",
      location: "İstanbul (Hibrit)", start: "2022-03", end: "", current: true,
      description:
    ...
    {
      _id: 2, role: "Frontend Developer", company: "Getir",
      location: "İstanbul", start: "2020-01", end: "2022-02", current: false,
      description:
  ...
  education: [
    {
      _id: 11, school: "Boğaziçi Üniversitesi", degree: "Lisans",
      field: "Bilgisayar Mühendisliği", start: "2015-09", end: "2019-06",
      gpa: "3.42 / 4.00",
  ...
  projects: [
    {
      _id: 21, name: "OpenForm", stack: "React, TypeScript, Supabase",
      link: "github.com/aysedemir/openform",
      description: "Açık kaynak form builder; 1.2k GitHub yıldızı\nDrag-drop editör ve gerçek zamanlı işbirliği özellikleri",
    },
  ],
  certifications: [
    { _id: 41, name: "AWS Certified Solutions Architect", issuer: "Amazon Web Services", date: "2023-04", link: "" },
  ],
  awards: [
    { _id: 51, title: "Yılın En İyi Geliştirici", issuer: "Trendyol", date: "2023-12", note: "200+ geliştirici arasından seçildi" },
  ],
  skills: [
...
export const FONT_OPTIONS: FontOption[] = [
  ...
  { id:"calibri",     label:"Calibri",                  css:'Calibri,Candara,"Segoe UI",Arial,sans-serif' },
  { id:"inter",       label:"Inter (Modern Sans)",      css:'var(--font-inter)' },
  { id:"roboto",      label:"Roboto (Teknik)",           css:'var(--font-roboto)' },
  { id:"opensans",    label:"Open Sans (Dengeli)",       css:'var(--font-opensans)' },
  { id:"lato",        label:"Lato (Minimal)",            css:'var(--font-lato)' },
  { id:"montserrat",  label:"Montserrat (Başlık)",       css:'var(--font-montserrat)' },
  { id:"poppins",     label:"Poppins (Yuvarlak)",        css:'var(--font-poppins)' },
  { id:"nunito",      label:"Nunito (Dost Canlısı)",     css:'var(--font-nunito)' },
  { id:"georgia",     label:"Georgia (Klasik Serif)",    css:'Georgia,"Times New Roman",serif' },
  { id:"times",       label:"Times New Roman",           css:'"Times New Roman",Times,serif' },
  { id:"merriweather",label:"Merriweather (Derin Serif)",css:'var(--font-merriweather)' },
  { id:"playfair",    label:"Playfair Display (Zarif)",  css:'var(--font-playfair)' },
  { id:"sourceserif", label:"Source Serif 4 (Makale)",   css:'var(--font-sourceserif)' },
];
...
export const MARGIN_OPTIONS: MarginOption[] = [
  { id:"narrow", label:"Dar (12mm)",     px:40,  mm:12 },
  { id:"normal", label:"Normal (18mm)",  px:56,  mm:18 },
  { id:"wide",   label:"Geniş (24mm)",   px:72,  mm:24 },
];

// ── Bölüm tanımları ───────────────────────────────────────────────────────────
export const SECTION_DEFS = [
  { id:"about",          label:"Profesyonel Özet / Hakkımda" },
  { id:"experience",     label:"İş Deneyimleri"              },
  { id:"education",      label:"Eğitim Bilgileri"            },
  { id:"projects",       label:"Projeler"                    },
  { id:"certifications", label:"Sertifikalar & Kurslar"      },
  { id:"awards",         label:"Ödüller & Başarılar"         },
